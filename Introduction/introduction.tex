...
%\begin{frame}{Cross-Sectional Identification and Aggregation}
%\begin{itemize}
%\item Step 1:
%\item Success: can convincingly establish that you estimated a causal effect.  
%\item Step 2: build model that matches cross-sectional causal effect.
%\item Success: can distinguish between competing models that have important different aggregate implications.
%\item Is it unfair to be a macroeconomist?
%\end{itemize}
%\end{frame}

%\begin{frame}{Aggregate versus Cross-Sectional Identification}
%\begin{itemize}
%\item Generally, would like to directly estimate effect of monetary/fiscal policy on economy.
%\item Very difficult identification problem.
%\item Some identification challenges can be addressed in the cross-section.
%\begin{itemize}
%\item Mian-Sufi 14, Nakamura-Steinsson 14, Autor-Dorn-Hanson 13, Baraja-Hurst-Ospina 16, Martin-Phillipon 17, ...
%\end{itemize}
%\end{itemize}
%\end{frame}

%\begin{frame}{Example: Housing in Great Recession}
%\begin{itemize}
%\item Mian-Sufi-Rao: Cities where house prices fell more saw larger drop in consumption and non-tradable employment
%\begin{itemize}
%\item Use Saiz 10 instrument to isolate causal effect from housing to consumption and employment
%\end{itemize}
%\item Results informative about ``consumption block'' of macro models
%\begin{itemize}
%\item Rejects simple Sinai-Souleles 05 complete markets model
%\item More consistent with incomplete markets/life-cycle model (e.g., Berger et al. 17)
%\end{itemize}
%\item Simpler alternative: Look at raw correlation between housing, consumption, etc
%\begin{itemize}
%\item Sensitive to auxiliary assumptions (e.g., what shocks drive the cycle)
%\end{itemize}
%\item How convincing is this argument?
%\end{itemize}
%\end{frame}

%\begin{frame}{Set Identification}
%Any given set of identified moments typically: \\
%$\;$
%\begin{itemize}
%\item Consistent with several models (but not all models).
%\item I.e., partially identify model space.
%\end{itemize}
%$\;$\\
%Point-identifying correct model unrealistic:\\
%$\;$
%\begin{itemize}
%\item Several models being consistent with a statistic not grounds for throwing out statistic.
%\item Think in reverse: If statistic provides evidence against an important class of models, statistic is useful. 
%\end{itemize}
%\end{frame}
%
%
%
%\begin{frame}{Cross-Sectional Identification in Macro}
%\begin{itemize}
%\itemsep1em
%\item Cross-sectional causal effects often powerful diagnostic tools to distinguish between models.
%\item Approach:
%\begin{itemize}
%\item Use cross-sectional responses as moments in estimation of structural models.
%\item Use favored structural model to answer aggregate questions.
%\end{itemize}
%\end{itemize}
%\end{frame}
%
%\begin{frame}{Fiscal Stimulus: Aggregate Evidence}
%\begin{itemize}
%\itemsep1em
%\item Barro-Redlick 11 use evidence from wars:
%\begin{itemize}
%\item Government purchases multiplier of 0.6-0.7
%\item Most identification from WWI, WWII, Korean War
%\item Conceptually: Use wars as instrument for spending
%\item Potential violations of exclusion restriction: patriotism, rationing, etc.
%\end{itemize}
%\item Blanchard-Perotti 02 use SVAR:
%\begin{itemize}
%\item Peak output response of 1.3 after 15 quarters
%\item Very large standard errors
%\item Highly sensitive to sample period, controls \\ {\small (see, e.g., Gali et al. 07, Ramey 11, 16)}
%\end{itemize}
%\end{itemize}
%\end{frame}
%
%\begin{frame}{Fiscal Stimulus: Cross-Sectional Evidence}
%\begin{itemize}
%\item Explosion of work post Great Recession:
%\begin{itemize}
%\item Chodorow-Reich et al. 12, Wilson 12, Shoag 15, Nakamura-Steinsson 14, Acconcia et al. 14, Dupor-Mehkari 16, etc.  
%\end{itemize}
%\item Survey by Chodorow-Reich 17
%\item Estimates of local fiscal multiplier cluster at 1.5-2.0
%\item Nakamura-Steinsson 14: consistent with ``ultra-Keynesian'' models, not consistent with RBC model.
%\end{itemize}
%\end{frame}
%
