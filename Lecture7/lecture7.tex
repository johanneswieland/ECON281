...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Auclertn Bardozsy, Rognlie, Straub (2021)}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\begin{frame}
    \frametitle{Sequence Space Methods}
    \begin{itemize}
    	\item Sequence Space methods mean we use linear algebra to solve our models: easy!
        ...
        \item This paper: clever algorithm that exploits structure of the model to get the Jacobians of the model really fast!
    \end{itemize}
\end{frame}
